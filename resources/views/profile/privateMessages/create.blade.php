        ...
        <div class="relative py-3 w-11/12 max-w-xl sm:mx-auto">
            <div class="relative p-8 bg-white shadow-sm sm:rounded-xl">
                @auth
                    ...
                    @if(request()->slugified_user)
                        <div class="mb-5 relative">
                            <input type="participants" name="participants" id="participants" class="peer pt-8 border border-gray-200 focus:outline-none rounded-md focus:border-gray-500 focus:shadow-sm w-full p-3 h-16 placeholder-transparent" placeholder="shadowrunner245" autocomplete="off" value="{{ $username }}," />
