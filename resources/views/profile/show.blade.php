<x-layout title="{{ $profileUser->username }}">
    <x-normalPage>
        ...
        @if($profileUser->username === auth()->user()->username)
            <a href="/me/new/private-message">Start a Conversation With Yourself</a>
        @else
            <a href="/profile/{{request()->slugified_user}}/new/private-message">Start a Converstion With {{$profileUser->username}}</a>
        @endif
